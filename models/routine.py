...
from models.routineproduct import RoutineProductSchema, RoutineProduct
...
class RoutineSchema(ma.Schema):
    ...
    routine_products = fields.Nested(RoutineProductSchema, many=True)

    class Meta:
        fields = ('id', 'created_at', 'day_of_week', 'time_of_day', 'user_id', 'routine_products')
